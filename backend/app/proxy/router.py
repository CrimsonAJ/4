"""
ProxiBase Proxy Router - Phase 4
Core proxy functionality with redirect interception
"""
...
async def proxy_handler(
    ...
    # If host is admin host, skip (handled by admin router)
    ...
    # SSRF protection
    if not is_safe_origin_url(origin_url):
        return Response(
            content=f"Blocked: unsafe origin URL",
            status_code=403
        )
